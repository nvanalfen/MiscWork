...
def compute_ellipse2d_dumb(a, b, c, pos, major_axes, inter_axes, minor_axes, Nphi=100, Ntheta=100):
    # print("Shapes")
    # print(a.shape)
    # print(b.shape)
    # print(c.shape)
    # print(pos.shape)
    # print(major_axes.shape)
    # print(inter_axes.shape)
    # print(minor_axes.shape)
