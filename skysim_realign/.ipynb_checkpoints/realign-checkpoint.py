...
if rank==0:
    ...
    halo_axisA_x = data["baseDC2/target_halo_axis_A_x"]
    halo_axisA_y = data["baseDC2/target_halo_axis_A_y"]
    halo_axisA_z = data["baseDC2/target_halo_axis_A_z"]
    ...
    rewrite_mask = data["baseDC2/target_halo_mass"] < MASS_THRESH
    sxx = data["tidal_s_11"][rewrite_mask]
    sxy = data["tidal_s_12"][rewrite_mask]
    syy = data["tidal_s_22"][rewrite_mask]
    redshift = data["redshiftHubble"][rewrite_mask]
    tidal_phi = tidal_angle(sxx, syy, sxy, redshift)
    tidal_corrected_major = align_to_axis_2d(tidal_vec, mu, as_vector=False, custom_distr=dwvm)
